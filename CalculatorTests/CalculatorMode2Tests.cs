...
{
    public class CalculatorMode2Tests
    {
        ...
        static readonly ServiceExpression expectedValid2 = new("(1)*(1)/(1)+(1)-(1)", 1, true, "");
        static readonly ServiceExpression expectedValid3 = new("((((((((100))))))))+((((((((100))))))))", 200, true, "");
        ...
        {
            ServiceExpression expression = new CalculatorMode2().Calculate(actual);
